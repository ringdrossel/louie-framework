...
| `louie-language` | `_LOUIE_/commands/louie-language.md` | View or change the project language (conversation language + document language) |
...
- `_LOUIE_/guidelines/execution-guidelines.md` — how work runs (sequential baseline, work packages, subagent dispatch on capable runtimes)
